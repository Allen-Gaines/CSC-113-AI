    ...
    <div id="gameContainer">
        ...
        <div id="startScreen">
            ...
            <div id="instructions">
                ...
                <p>🎯 Click empty spots to place turrets (Cost: 50 resources)</p>
                <p>⚡ Click existing turrets to upgrade them (3 levels max)</p>
                <p>🚀 Turrets automatically target and fire homing projectiles</p>
                <p>🛡️ Protect your base from alien invasion!</p>
                <p>⭐ Each wave gets harder - plan and upgrade your defense!</p>
            </div>
        </div>
